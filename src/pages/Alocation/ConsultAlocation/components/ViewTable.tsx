      ...
      <div className="h-fit ">
        <table className="">
          ...
          <tbody className="border border-gray-800 rounded-b-md">
            <tr>
              <td
                className=" w-60 h-14 border-r border-gray-800 text-center whitespace-nowrap"
                scope="row"
              >
                {data.cnpj}
              </td>
              <td className=" w-60 h-14 border-r border-gray-800 text-center ">
                {data.razaoSocial}
              </td>
              <td className=" w-60 h-14 border-r border-gray-800 text-center ">
                {data.dataConsulta}
              ...
              <td className=" w-60 h-14 border-r border-gray-800 text-center ">
                {"R$" + data.valorUnitario}
              </td>
              <td className=" w-60 h-14 border-r border-gray-800 text-center ">
                {data.numeroCotas}
              </td>
              <td className=" w-60 h-14 border-r border-gray-800 text-center ">
                {"R$" + data.valorMedio.toFixed(2)}
              </td>
              <td className=" w-60 h-14 border-r border-gray-800 text-center ">
                {(data.retorno * 100).toFixed(2) + "%"}
              </td>
              <td className=" w-60 h-14 border-gray-800 text-center ">
                {"R$" + data.saldo}
              </td>
            </tr>
          </tbody>
