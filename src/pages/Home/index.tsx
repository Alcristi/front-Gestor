		...
		<Theme>
			<div className=" ">
				<div className="flex flex-col items-center justify-evenly w-50 h-80">
						<div>
							<Link to="/admin">
								<span className= "bg-white text-gray-800 border  border-gray-800 rounded-2xl p-4 w-50 block hover:bg-gray-700 hover:text-white  hover:borderblack" >Administrador</span>
							</Link>
						</div>
						<div>
							<Link to="/register">
